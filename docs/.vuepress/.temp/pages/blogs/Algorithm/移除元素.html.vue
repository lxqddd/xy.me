<template><div><h1 id="移除元素" tabindex="-1"><a class="header-anchor" href="#移除元素" aria-hidden="true">#</a> 移除元素</h1>
<ol>
<li>定义一个指针，通过 while 循环，遍历数组</li>
<li>判断指针指向的当前值和目标值是否相等，如果相等，则移除当前项</li>
<li>如果不相等，向右移动指针</li>
</ol>
